"""CLI: ``python -m veriworld.benchmark.computational.feedback.surface_billiards``."""
...
def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Run SurfaceBilliards for one seed against one model")
...
async def _amain() -> None:
    ...
    # ComputationalEngine launches/relaunches UE itself — the task calls next_round
